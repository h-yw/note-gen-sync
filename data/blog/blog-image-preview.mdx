...
&emsp;&emsp;这里就具体贴一下代码实现。另外，图片过大的话 blurhash encode 的时候会非常耗时（一开始跑脚本卡着不动，我都以为是我的脚本写的有问题😖），我就只好在 encode 前将图片重整大小。因为 \*\*\_next/image\_\*\* 用 \*\*\_sharp\_\*\* 来做图片优化，所以我重整图片大小时也用了sharp。
...
![原图->编码->解码](![bf5bfb88-0588-4810-83cc-82e22b929486.png](https://raw.githubusercontent.com/h-yw/note-gen-image-sync/master/bf5bfb88-0588-4810-83cc-82e22b929486.png))
